...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _components_js_api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/js/api.js */ \"./src/components/js/api.js\");\n\n\n\nconst playerBox = document.querySelector('.ranks');\nconst refreshBtn = document.getElementById('refresh');\nconst form = document.getElementById('form');\nconst name = document.getElementById('name');\nconst score = document.getElementById('score');\nconst msgBox = document.querySelector('.submission_status');\nlet players;\n\nwindow.addEventListener('load', () => {\n  (0,_components_js_api_js__WEBPACK_IMPORTED_MODULE_1__.refreshApiData)(players, playerBox);\n});\n\nrefreshBtn.addEventListener('click', () => {\n  (0,_components_js_api_js__WEBPACK_IMPORTED_MODULE_1__.refreshApiData)(players, playerBox);\n});\n\nform.addEventListener('submit', async (e) => {\n  e.preventDefault();\n  await (0,_components_js_api_js__WEBPACK_IMPORTED_MODULE_1__.addEntry)(name, score, msgBox);\n  (0,_components_js_api_js__WEBPACK_IMPORTED_MODULE_1__.refreshApiData)(players, playerBox);\n  name.value = '';\n  score.value = '';\n});\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
